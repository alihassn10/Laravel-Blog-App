...
<head>
 ...
 /* Change to your preferred background color */
        ...
        .logo img {
            max-width: 100%;
            height: auto;
            max-height: 67px; /* Adjust the max-height based on your preference */
        }
...
<body>
    <header class="header-bar mb-3">
        <div class="container d-flex flex-column flex-md-row align-items-center p-3">
            ...
            <a href="/" class="logo">
                <img src="https://i.ibb.co/RN41z4X/Scribble-Sphere-is-a-blogging-site-make-a-aesthe-removebg-preview.png" alt="Scribble-Sphere" border="0">
            </a>
...
<div class='container'>
  ...
  @endif()
    ...
    var failureAlert = document.querySelector('.alert-danger');
